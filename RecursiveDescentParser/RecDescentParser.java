...
public class RecDescentParser {
    ...
    public static void main(String[] args) throws Exception {
    	/*RecDescentParser rdp = new RecDescentParser("x = y * (a + 2 - c) + A $");
    	rdp.start();
                 
    	RecDescentParser rdp2 = new RecDescentParser("z = a + (b + 1)) $");
        rdp2.start();
         
        RecDescentParser rdp3 = new RecDescentParser("u = 7;v = a + 8; x = 3$");
        rdp3.start();
        
        RecDescentParser rdp4 = new RecDescentParser("c = z + 341 + 5; x = 100$");
        rdp4.start();*/
      }
